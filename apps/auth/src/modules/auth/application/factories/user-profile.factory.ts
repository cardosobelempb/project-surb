  ...
  static build(input: CreateUserProfileDto): UserProfileEntity {
    return UserProfileEntity.create({
      ...
      birthDate: input.birthDate
        ? BirthDateVO.create(input.birthDate)
        : BirthDateVO.create(""),
      phone: input.phone ? PhoneVO.create(input.phone) : PhoneVO.create(""),
      avatarUrl: input.avatarUrl ? UrlVO.create(input.avatarUrl) : UrlVO.create(""),
      documentType: input.documentType ? input.documentType : undefined,

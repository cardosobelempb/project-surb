...
export const UserProfileSchema = z
  .object({
    ...
    firstName: s.name,
    lastName: s.name,
    displayName: s.name.nullable(), // displayName pode ser nulo, será gerado automaticamente se não fornecido
    fullName: s.name.nullable(),
    birthDate: BirthDateSchema.nullable(),
    phone: PhoneSchema.nullable(),
    avatarUrl: s.url.nullable(),
    documentType: z.enum(DocumentType).nullable(),
    status: z.enum(UserProfileStatus).nullable(),
...
export const UserProfilePageResponseSchema = pageResponseSchema(UserProfileSummarySchema);
